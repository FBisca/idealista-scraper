    ...
    <main class="items-container">
      ...
      <article class="item item-multimedia-container" data-element-id="110081746">
        ...
        <picture class="logo-branding">
          ...
          <div class="price-row">
            <span class="item-price h2-simulated">317.000€<span class="txt-big">€</span></span>
            <span class="pricedown">
                <span class="pricedown_price">
                    322.000 €
                </span>
                <span class="pricedown_icon icon-pricedown">5%</span>
            </span>
